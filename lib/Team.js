...
class Team {
    ...
    startBuild() {
        this.createEmployee(this.questions.officeNumber, 'manager', Manager)
    }

    createEmployee(roleQuestion, role, roleConstructor) {
    ...
    addEmployee() {
        inquirer.prompt(this.questions.promptNewEmployee)
            .then(answer => {
                const { newEmployee } = answer;
                switch (newEmployee) {
                    case 'Engineer':
                        this.createEmployee(this.questions.github, 'engineer', Engineer)
                        break;
                    case 'Intern':
                        this.createEmployee(this.questions.school, 'intern', Intern)
                        break;
